...
Verified Results
<!-- TODO: fill in with your own on-device numbers, e.g.: | Metric | Stock | After OC | |---|---|---| | CPU LL idx0 | ... MHz | ... MHz | | CPU B idx0 | ... MHz | ... MHz | | GPU OPP[0] | ... MHz / ... mV | ... MHz / ... mV | -->

Not yet filled in — add your tested stable targets here once confirmed on-device.
...
Or as part of a full pipeline run — see docs/ADDONS.md:
